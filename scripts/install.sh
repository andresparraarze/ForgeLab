#!/usr/bin/env bash
# Generic, client-agnostic ForgeLab installer.
#
...
# 2. venv (python -m venv on an existing venv is a no-op refresh, not an error)
...
# 5. Put forgelab / forgelab-mcp / forgelab init on the PATH
